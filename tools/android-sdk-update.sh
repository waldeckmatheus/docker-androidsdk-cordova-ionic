...
then
    ...
    mkdir -p cmdline-tools/latest/ \
      && curl -sSL https://dl.google.com/android/repository/commandlinetools-linux-8512546_latest.zip -o sdk-tools-linux.zip \
      && unzip sdk-tools-linux.zip -d /tmp/cmd-tools-latest && mv /tmp/cmd-tools-latest/cmdline-tools/* /opt/android-sdk-linux/cmdline-tools/latest/ \
